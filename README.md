...
folder it changed in, so there is no hunting. Files open **in the page**, and
Back is reachable from everywhere. The only thing offered as a download is an
office file or a PDF, on its own page, behind a button she has to press.
...
**Essays** folder, and two task lists — **School** (with a nested subtask, one overdue
